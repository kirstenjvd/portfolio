      ...
      <div class="section" id="section-about">
        <div class="fc wrapper">
          ...
          <div class="container-box type-2 where">
            ...
            <h2>where</h2>
            <div class="container-copy">
              <p>Kirsten has lived in cities across North America, always finding new sources of creativity and innovation in each. Today she calls <strong>Victoria, BC</strong> home.</p>
            </div>
          </div>
